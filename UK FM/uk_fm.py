...
class test(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        ...
        self.frequency = frequency = 98.8e6
        ...
        self._vga_gain_range = qtgui.Range(0, 200, 1, 20, 200)
        self._vga_gain_win = qtgui.RangeWidget(self._vga_gain_range, self.set_vga_gain, "VGA gain", "counter_slider", float, QtCore.Qt.Horizontal)
        self.top_layout.addWidget(self._vga_gain_win)
        self._sample_rate_range = qtgui.Range(1e6, 10e6, 1e6, 2e6, 200)
        ...
        self._if_gain_range = qtgui.Range(0, 60, 1, 20, 200)
        ...
        self._freq_range = qtgui.Range(80e6, 130e6, 1e5, 98.8e6, 200)
    ...
    def set_sample_rate(self, sample_rate):
        ...
        self.low_pass_filter_0.set_taps(firdes.low_pass(1, self.sample_rate, 100e3, 10e3, window.WIN_HAMMING, 6.76))
